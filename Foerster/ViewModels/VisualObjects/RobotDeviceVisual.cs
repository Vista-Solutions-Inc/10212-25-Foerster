...
{
    public partial class RobotDeviceVisual : DeviceVisual
    {
        public RobotDeviceVisual(IDevice device, ISnackbarService snackbarService) : base(device, snackbarService)
        {
        ...
        [RelayCommand] private void OnSendRobotHome(object content)
        {
            throw new NotImplementedException();
        }

        [RelayCommand] private void OnStopRobotMotion(object content)
        {
            throw new NotImplementedException();
        }
